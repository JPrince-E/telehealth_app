...
class _SuperAdminScreenState extends State<SuperAdminScreen> {
  ...
  int type = -1;
  String userRole = ''; // 0 for doctor, 1 for nurse
  ...
  void _registerAccount() async {
    ...
    if (user != null) {
      ...
      String name =
      (type == 0) ? 'Dr. ${_displayName.text}' : 'Nurse ${_displayName.text}';
      String accountRole = (type == 0) ? 'doctor' : 'nurse';
      ...
      if ( type == 1) {
        ...
        globals.isNurse = true;
        globals.userRole = 'nurse';
        globals.role = 'nurse';
      }

      // sep
      FirebaseFirestore.instance.collection(accountRole).doc(user.uid).set(mp);
